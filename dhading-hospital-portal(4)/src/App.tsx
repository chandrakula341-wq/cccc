...
export default function App() {
  ...
  // Master database synchronizer (Fallback to local initial data if no backend)
  useEffect(() => {
    // Relying on seedData.ts imported at top-level. 
    // This allows the deployable static ZIP to work 100% fine on its own!
  }, []);
